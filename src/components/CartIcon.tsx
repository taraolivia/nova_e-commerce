  ...
  return (
    <div className="relative z-50">
      ...
      {isOpen && (
        <div
          ref={overlayRef}
          className="absolute right-0 mt-2 w-[50rem] bg-white border shadow-xl rounded-lg"
        >
              ...
              items.map((item) => (
                ...
                >
                  <Link
                    ...
                    className="flex gap-3 flex-1 hover:opacity-90"
                  >
                    <Image
                      src={item.image.url}
                      alt={item.image.alt}
          ...
          <div className="border-t px-4 py-3">
            ...
            <Link
              href="/cart"
              onClick={closeOverlay}
              className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white py-2 rounded text-sm font-medium"
            >
              Go to cart
            </Link>
          </div>
